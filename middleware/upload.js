...
export const uploadPeopleAvatar = createUploader('people/avatars');
export const uploadPeopleCover = createUploader('people/covers');
export const uploadPeoplePortfolio = createUploader('people/portfolio');
