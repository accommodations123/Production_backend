...
router.get("/admin/hosts/pending", adminAuth, requireRole("super_admin", "admin"), auditContext("admin"), getPendingHosts)
router.put("/admin/hosts/approve/:id", adminAuth, requireRole("super_admin", "admin"), auditContext("admin"), approveHost)
router.put("/admin/hosts/reject/:id", adminAuth, requireRole("super_admin", "admin"), auditContext("admin"), rejectHost)
router.get("/admin/hosts/approved", adminAuth, requireRole("super_admin", "admin"), auditContext("admin"), getApprovedHosts);
router.get("/admin/hosts/rejected", adminAuth, requireRole("super_admin", "admin"), auditContext("admin"), getRejectedHosts);
